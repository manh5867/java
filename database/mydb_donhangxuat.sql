...
CREATE TABLE `donhangxuat` (
  ...
  `DELIVERY_TIME_EXP` datetime NOT NULL,
  `ORDER_TIME_EXP` datetime NOT NULL,
  `TOTAL_PRICE_EXP` varchar(45) NOT NULL,
  `CUSTOMER ID` varchar(45) NOT NULL,
  `khachHang_CUSTOMER_ID` varchar(45) NOT NULL,
  PRIMARY KEY (`EXPORT_ID`,`khachHang_CUSTOMER_ID`),
  KEY `fk_donHangXuat_khachHang1_idx` (`khachHang_CUSTOMER_ID`)
...
-- Dump completed on 2023-06-20 20:47:48
