...
CREATE TABLE `donhangnhap` (
  ...
  `DELIVERY_IMP` datetime NOT NULL,
  `TOTAL_COST_IMP` varchar(45) NOT NULL,
  `nhaCungCap_SUPPLIER_ID` int NOT NULL,
  PRIMARY KEY (`IMPORT_ID`,`nhaCungCap_SUPPLIER_ID`),
  KEY `fk_donHangNhap_nhaCungCap1_idx` (`nhaCungCap_SUPPLIER_ID`),
  CONSTRAINT `fk_donHangNhap_nhaCungCap1` FOREIGN KEY (`nhaCungCap_SUPPLIER_ID`) REFERENCES `nhacungcap` (`SUPPLIER_ID`)
