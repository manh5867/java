...
CREATE TABLE `chitietdonhangnhap` (
  ...
  `donHangNhap_IMPORT_ID` varchar(16) NOT NULL,
  PRIMARY KEY (`IMPORTDETAIL_ID`,`donHangNhap_IMPORT_ID`),
  KEY `fk_chiTietDonHangNhap_donHangNhap1_idx` (`donHangNhap_IMPORT_ID`),
  CONSTRAINT `fk_chiTietDonHangNhap_donHangNhap1` FOREIGN KEY (`donHangNhap_IMPORT_ID`) REFERENCES `donhangnhap` (`IMPORT_ID`)
...
-- Dump completed on 2023-06-20 20:47:46
