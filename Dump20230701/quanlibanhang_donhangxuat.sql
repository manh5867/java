...
CREATE TABLE `donhangxuat` (
  ...
  `DELIVERY_TIME_EXP` varchar(45) DEFAULT NULL,
  `ORDER_TIME_EXP` varchar(45) DEFAULT NULL,
  `TOTAL_PRICE_EXP` varchar(45) DEFAULT NULL,
  `CUSTOMER_ID` int DEFAULT NULL,
  PRIMARY KEY (`EXPORT_ID`),
  KEY `CUSTOMER_ID_idx` (`CUSTOMER_ID`),
  CONSTRAINT `CUSTOMER_ID` FOREIGN KEY (`CUSTOMER_ID`) REFERENCES `khachhang` (`CUSTOMER_ID`)
...
INSERT INTO `donhangxuat` VALUES (123,'2023-11-29','2023-10-20','40000',1);
