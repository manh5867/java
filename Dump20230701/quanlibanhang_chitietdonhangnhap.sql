...
CREATE TABLE `chitietdonhangnhap` (
  ...
  `QUANTITY_IMP` varchar(45) DEFAULT NULL,
  `COST_EXP` varchar(45) DEFAULT NULL,
  `IMPORT_ID` varchar(16) DEFAULT NULL,
  PRIMARY KEY (`IMPORTDETAIL_ID`),
  KEY `IMPORT_ID_idx` (`IMPORT_ID`),
  CONSTRAINT `IMPORT_ID` FOREIGN KEY (`IMPORT_ID`) REFERENCES `donhangnhap` (`IMPORT_ID`)
...
INSERT INTO `chitietdonhangnhap` VALUES (12345,'12213','313','50000','123');
