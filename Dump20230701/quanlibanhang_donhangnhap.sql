...
CREATE TABLE `donhangnhap` (
  ...
  `ORDER_TIME_IMP` date DEFAULT NULL,
  `DELIVERY_IMP` date DEFAULT NULL,
  `TOTAL_COST_IMP` varchar(45) DEFAULT NULL,
  `SUPPLIER_ID` int DEFAULT NULL,
  PRIMARY KEY (`IMPORT_ID`),
  KEY `SUPPLIER_ID_idx` (`SUPPLIER_ID`),
  CONSTRAINT `SUPPLIER_ID` FOREIGN KEY (`SUPPLIER_ID`) REFERENCES `nhacungcap` (`SUPPLIER_ID`)
...
INSERT INTO `donhangnhap` VALUES ('123','2020-10-18','2020-11-19','50000',1234),('1234567','2020-10-18','2020-11-19','50000',1234);
