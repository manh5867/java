...
CREATE TABLE `chitietsanpham` (
  ...
  CONSTRAINT `chitietsanpham_ibfk_1` FOREIGN KEY (`SUPPLIER_ID`) REFERENCES `nhacungcap` (`SUPPLIER_ID`),
  CONSTRAINT `chitietsanpham_ibfk_2` FOREIGN KEY (`PRODUCT_ID`) REFERENCES `sanpham` (`PRODUCT_ID`)
