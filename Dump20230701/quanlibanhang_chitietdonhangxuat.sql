...
CREATE TABLE `chitietdonhangxuat` (
  ...
  KEY `EXPORT_ID_idx` (`EXPORT_ID`),
  CONSTRAINT `EXPORT_ID` FOREIGN KEY (`EXPORT_ID`) REFERENCES `donhangxuat` (`EXPORT_ID`)
...
INSERT INTO `chitietdonhangxuat` VALUES (236,'213','123313','5000000',123);
